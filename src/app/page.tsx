    ...
    items: [
      {
        ...
        price: "$3.50",
        description:
          "Sausage, egg and cheese on corn or flour. Salsa upon request.",
      },
      {
        name: "Breakfast Bowl",
        price: "$7.50",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Taco Pizza",
        price: "$13.50",
        description: "Salsa, taco meat and cheese, topped with lettuce, pico and sour cream.",
      },
      {
        name: "Meat Lovers",
        price: "$15.00",
  ...
  return (
    <>
      ...
      <main id="home" className="flex-1 pb-28">
        ...
        <SbSection id="food-menu" className="py-5">
          <SbContainer className="space-y-3">
            <SbSectionHeader
              title="Food Menu"
